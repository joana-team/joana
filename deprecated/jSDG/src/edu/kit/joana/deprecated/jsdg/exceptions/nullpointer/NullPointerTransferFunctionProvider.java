 ...
 *
 */
class NullPointerTransferFunctionProvider<T extends ISSABasicBlock> implements ITransferFunctionProvider<T, EdgeState> {

	private final AbstractMeetOperator<EdgeState> meet = EdgeState.meetOperator();
	 ...
	 */
	@Override
	public UnaryOperator<EdgeState> getEdgeTransferFunction(T src, T dst) {
		...
		return EdgeState.identityFunction();
	}
	 ...
	 */
	@Override
	public AbstractMeetOperator<EdgeState> getMeetOperator() {
		return meet;
	}
	 ...
	 */
	@Override
	public UnaryOperator<EdgeState> getNodeTransferFunction(T node) {
		throw new IllegalStateException("We do not have such a thing dude!");
	}
	...
	private static class TransferFunctionSSAVisitor implements IVisitor {
		...
		private UnaryOperator<EdgeState> transfer1 = EdgeState.identityFunction();

		// used for false case of if clause and exceptional path
		private UnaryOperator<EdgeState> transfer2 = EdgeState.identityFunction();
		...
		public void visitArrayLength(SSAArrayLengthInstruction instruction) {
			noIdentity = true;
			transfer1 = EdgeState.denullifyFunction(instruction.getArrayRef());
			transfer2 = EdgeState.nullifyFunction(instruction.getArrayRef());
		}
		...
		public void visitBinaryOp(SSABinaryOpInstruction instruction) {
			noIdentity = false;
			transfer1 = EdgeState.identityFunction();
			transfer2 = EdgeState.identityFunction();
		}
		...
		public void visitConditionalBranch(SSAConditionalBranchInstruction instruction) {
			...
			if (sym.isNullConstant(arg1)) {
				...
				case EQ:
					noIdentity = true;
					transfer1 = EdgeState.nullifyFunction(arg2);
					transfer2 = EdgeState.denullifyFunction(arg2);
					break;
				case NE:
					noIdentity = true;
					transfer1 = EdgeState.denullifyFunction(arg2);
					transfer2 = EdgeState.nullifyFunction(arg2);
					break;
				default:
				...
				case EQ:
					noIdentity = true;
					transfer1 = EdgeState.nullifyFunction(arg1);
					transfer2 = EdgeState.denullifyFunction(arg1);
					break;
				case NE:
					noIdentity = true;
					transfer1 = EdgeState.denullifyFunction(arg1);
					transfer2 = EdgeState.nullifyFunction(arg1);
					break;
				default:
					throw new IllegalStateException("Comparision to a null constant using " + op);
				}
		...
		public void visitGet(SSAGetInstruction instruction) {
			if (!instruction.isStatic()) {
				...
				noIdentity = true;
				transfer1 = EdgeState.denullifyFunction(ssaVar);
				transfer2 = EdgeState.nullifyFunction(ssaVar);
			} else {
				noIdentity = false;
				transfer1 = EdgeState.identityFunction();
				transfer2 = EdgeState.identityFunction();
		...
		public void visitInvoke(SSAInvokeInstruction instruction) {
			if (!instruction.isStatic()) {
				...
				noIdentity = true;
				transfer1 = EdgeState.denullifyFunction(instruction.getReceiver());
				transfer2 = EdgeState.identityFunction();
			} else {
				noIdentity = false;
				transfer1 = EdgeState.identityFunction();
		...
		public void visitMonitor(SSAMonitorInstruction instruction) {
			...
			noIdentity = true;
			transfer1 = EdgeState.denullifyFunction(instruction.getRef());
			transfer2 = EdgeState.identityFunction();
		}
		...
		public void visitNew(SSANewInstruction instruction) {
			 ...
			 */
			noIdentity = true;
			transfer1 = EdgeState.denullifyFunction(instruction.getDef());
			transfer2 = EdgeState.nullifyFunction(instruction.getDef());
		}
		...
		public void visitPhi(SSAPhiInstruction instruction) {
			...
			transfer1 = EdgeState.meetFunction(instruction.getDef(), uses);
