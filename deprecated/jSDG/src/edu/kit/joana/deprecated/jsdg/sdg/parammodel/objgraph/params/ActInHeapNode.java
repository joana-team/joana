...
/**
 * Actual-in nodes passed through the heap.
 *
 * @author Juergen Graf <graf@kit.edu>
 *
 */
public class ActInHeapNode extends ActInNode {

	public final OrdinalSet<InstanceKey> basePts;
	public final ParameterField baseField;

	ActInHeapNode(OrdinalSet<InstanceKey> basePts, ParameterField baseField, int id,
	...
	ActInHeapNode(ParameterField baseField, int id, boolean isPrimitive, TypeReference type,
