...
/**
 * Actual-in nodes passed through the stack.
 *
 * @author Juergen Graf <graf@kit.edu>
 *
 */
public class ActInLocalNode extends ActInNode {

	private final int paramNum;
	private final int displayParamNum;

	public ActInLocalNode(final int id, final boolean isPrimitive, final TypeReference type,
