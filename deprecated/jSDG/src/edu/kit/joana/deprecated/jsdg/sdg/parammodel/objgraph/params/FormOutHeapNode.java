...
/**
 * A formal-out node for a value passed through the heap.
 *
 * @author Juergen Graf <graf@kit.edu>
 *
 */
public class FormOutHeapNode extends FormOutNode {

	public final OrdinalSet<InstanceKey> basePts;
	public final ParameterField baseField;

	FormOutHeapNode(OrdinalSet<InstanceKey> basePts, ParameterField baseField, int id, boolean isPrimitive, TypeReference type,
	...
	FormOutHeapNode(ParameterField baseField, int id, boolean isPrimitive, TypeReference type,
			Set<PointerKey> pKey, OrdinalSet<InstanceKey> pts) {
		super(id, type, isPrimitive, pKey, pts);
		this.basePts = null;
		this.baseField = baseField;
