...
/**
 * A formal-out node for a value passed through the stack.
 *
 * @author Juergen Graf <graf@kit.edu>
 *
 */
public class FormOutLocalNode extends FormOutNode {

	private final int paramNum;
	private final int displayParamNum;

	public FormOutLocalNode(int id, boolean isPrimitive, TypeReference type, Set<PointerKey> pKey, OrdinalSet<InstanceKey> pts,
