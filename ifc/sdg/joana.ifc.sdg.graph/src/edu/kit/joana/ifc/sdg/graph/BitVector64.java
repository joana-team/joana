...
/**
 */
public class BitVector64 extends BitVectorBase64<BitVector64> {
  ...
  void expand(int newCapacity) {
    long[] oldbits = bits;
    bits = new long[subscript(newCapacity) + 1];
   ...
   */
  public BitVector64(BitVector64 s) {
    if (s == null) {
      throw new IllegalArgumentException("s is null");
    }
    bits = new long[s.bits.length];
    copyBits(s);
  }
  ...
  public final void set(int bit) {
    long shiftBits = bit & LOW_MASK;
    int subscript = subscript(bit);
    if (subscript >= bits.length) {
      expand(bit);
    }

    bits[subscript] |= ((long)1 << shiftBits);
  }
  ...
  public final boolean setWithResult(int bit) {
    ...
    long oldVal = bits[subscript];
    long newVal = oldVal | ((long)1 << shiftBits);
  ...
  public final boolean get(int bit) {
    ...
    long shiftBits = bit & LOW_MASK;
    return ((bits[ss] & ((long)1  << shiftBits)) != 0);
  }

  /**
   * Return the NOT of a bit string
   */
  public static BitVector64 not(BitVector64 s) {
    BitVector64 b = new BitVector64(s);
    b.not();
    return b;
  }
   ...
   */
  @Override
  public final void and(BitVector64 set) {
    if (set == null) {
   ...
   */
  public static BitVector64 and(BitVector64 b1, BitVector64 b2) {
    if (b1 == null) {
    ...
    BitVector64 b = new BitVector64(b1);
    b.and(b2);
    return b;
  }
   ...
   */
  @Override
  public final void or(BitVector64 set) {
    if (set == null) {
      throw new IllegalArgumentException("null set");
    }
  ...
  private void ensureCapacity(BitVector64 set) {
   ...
   */
  public final int orWithDelta(BitVector64 set) {
    if (set == null) {
   ...
   */
  public static BitVector64 or(BitVector64 b1, BitVector64 b2) {
    if (b1 == null) {
      throw new IllegalArgumentException("null b1");
    }
    if (b2 == null) {
   ...
   */
  public static BitVector64 xor(BitVector64 b1, BitVector64 b2) {
    if (b1 == null) {
      throw new IllegalArgumentException("null b1");
    }
    if (b2 == null) {
   ...
   */
  @Override
  public final void xor(BitVector64 set) {
    if (set == null) {
      throw new IllegalArgumentException("set is null");
    }
    ensureCapacity(set);
   ...
   */
  @Override
  public final boolean intersectionEmpty(BitVector64 other) {
    if (other == null) {
   ...
   */
  @Override
  public final boolean sameBits(BitVector64 B) {
    if (B == null) {
   ...
   */
  @Override
  public boolean isSubset(BitVector64 other) {
    if (other == null) {
  ...
  @Override
  public void andNot(BitVector64 vector) {
    if (vector == null) {
  ...
  public boolean equals(Object obj) {
    if ((obj != null) && (obj instanceof BitVector64)) {
      if (this == obj) { // should help alias analysis
        return true;
      }
      BitVector64 set = (BitVector64) obj;
      return sameBits(set);
    }
    return false;
  }
   ...
   * Return a new bit string as the AND of two others.
   */
  public static BitVector64 andNot(BitVector64 b1, BitVector64 b2) {
    BitVector64 b = new BitVector64(b1);
    b.andNot(b2);
    return b;
  }
