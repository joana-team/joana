 ...
 */
public class StepSlicerForward extends StepSlicer {

    /**
     * Creates a new instance of SummarySlicerForward
     */
	public StepSlicerForward(SDG graph, Set<SDGEdge.Kind> omit, Set<SDGEdge.Kind> step) {
        super(graph, omit, step);
    }

    public StepSlicerForward(SDG graph, Set<SDGEdge.Kind> omit) {
        super(graph, omit);
    }
