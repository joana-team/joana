 ...
 */
public class SummarySlicerBackward extends SummarySlicer {

    /**
     * Creates a new instance of SummarySlicerBackward
     */
    public SummarySlicerBackward(SDG graph, Set<SDGEdge.Kind> omit) {
        super(graph, omit);
    }

    public SummarySlicerBackward(SDG graph) {
        super(graph);
    }
        ...
        return new EdgePredicate() {
            ...
            public boolean saveInOtherWorklist(SDGEdge e) {
                return e.getKind() == SDGEdge.Kind.INTERFERENCE ||
                        ((e.getKind() == SDGEdge.Kind.DATA_DEP || e.getKind() == SDGEdge.Kind.DATA_HEAP || e.getKind() == SDGEdge.Kind.DATA_ALIAS ) &&
