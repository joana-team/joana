 ...
 */
public class SummarySlicerForward extends SummarySlicer {

    /**
     * Creates a new instance of SummarySlicerForward
     */
    public SummarySlicerForward(SDG graph, Set<SDGEdge.Kind> omit) {
        super(graph, omit);
    }

    public SummarySlicerForward(SDG graph) {
        super(graph);
    }
