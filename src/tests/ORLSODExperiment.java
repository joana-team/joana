...
public class ORLSODExperiment {
	...
	private static void doORLSOD2_precise() throws ClassHierarchyException, IOException, UnsoundGraphException, CancelException {
		SDG sdg = JoanaRunner.buildSDG("example/bin", "Lorlsod/ORLSOD2");
		CSDGPreprocessor.preprocessSDG(sdg);
		CFG redCFG = ReducedCFGBuilder.extractReducedCFG(sdg);
		Util.removeCallCallRetEdges(redCFG);
		DomExperiment.export(redCFG, DomExperiment.joanaGraphExporter(), "orlsod2.dot");
		PreciseMHPAnalysis mhp = PreciseMHPAnalysis.analyze(sdg);
		PruneInterferences.pruneInterferences(sdg, mhp);
		PrintWriter pw = new PrintWriter("orlsod2.pdg");
		SDGSerializer.toPDGFormat(sdg, pw);
		pw.close();
		Map<SDGNode, String> srcAnn = new HashMap<SDGNode, String>();
		srcAnn.put(sdg.getNode(5), BuiltinLattices.STD_SECLEVEL_HIGH);
		Map<SDGNode, String> snkAnn = new HashMap<SDGNode, String>();
		snkAnn.put(sdg.getNode(129), BuiltinLattices.STD_SECLEVEL_LOW);
		snkAnn.put(sdg.getNode(138), BuiltinLattices.STD_SECLEVEL_LOW);
	...
	private static void doORLSOD3_precise() throws ClassHierarchyException, IOException, UnsoundGraphException, CancelException {
		SDG sdg = JoanaRunner.buildSDG("example/bin", "Lorlsod/ORLSOD3");
		CSDGPreprocessor.preprocessSDG(sdg);
		CFG redCFG = ReducedCFGBuilder.extractReducedCFG(sdg);
		Util.removeCallCallRetEdges(redCFG);
		DomExperiment.export(redCFG, DomExperiment.joanaGraphExporter(), "orlsod3.dot");
		PreciseMHPAnalysis mhp = PreciseMHPAnalysis.analyze(sdg);
		PruneInterferences.pruneInterferences(sdg, mhp);
		PrintWriter pw = new PrintWriter("orlsod3.pdg");
		SDGSerializer.toPDGFormat(sdg, pw);
		pw.close();
		Map<SDGNode, String> srcAnn = new HashMap<SDGNode, String>();
		srcAnn.put(sdg.getNode(5), BuiltinLattices.STD_SECLEVEL_HIGH);
		Map<SDGNode, String> snkAnn = new HashMap<SDGNode, String>();
		snkAnn.put(sdg.getNode(139), BuiltinLattices.STD_SECLEVEL_LOW);
		snkAnn.put(sdg.getNode(148), BuiltinLattices.STD_SECLEVEL_LOW);
		ThreadModularCDomOracle tmdo = new ThreadModularCDomOracle(sdg);
		ProbInfComputer probInf = new ProbInfComputer(sdg, tmdo);
		ORLSODChecker<String> checker = new PathBasedORLSODChecker<String>(sdg, BuiltinLattices.getBinaryLattice(), srcAnn, snkAnn, probInf);
		checker.check();
	...
	private static void doORLSOD4_precise() throws ClassHierarchyException, IOException, UnsoundGraphException, CancelException {
		SDG sdg = JoanaRunner.buildSDG("example/bin", "Lorlsod/ORLSOD4");
		CSDGPreprocessor.preprocessSDG(sdg);
		CFG redCFG = ReducedCFGBuilder.extractReducedCFG(sdg);
		Util.removeCallCallRetEdges(redCFG);
		DomExperiment.export(redCFG, DomExperiment.joanaGraphExporter(), "orlsod4.dot");
		PreciseMHPAnalysis mhp = PreciseMHPAnalysis.analyze(sdg);
		PruneInterferences.pruneInterferences(sdg, mhp);
		PrintWriter pw = new PrintWriter("orlsod4.pdg");
		SDGSerializer.toPDGFormat(sdg, pw);
		pw.close();
		Map<SDGNode, String> srcAnn = new HashMap<SDGNode, String>();
		srcAnn.put(sdg.getNode(5), BuiltinLattices.STD_SECLEVEL_HIGH);
		Map<SDGNode, String> snkAnn = new HashMap<SDGNode, String>();
		snkAnn.put(sdg.getNode(131), BuiltinLattices.STD_SECLEVEL_LOW);
		snkAnn.put(sdg.getNode(140), BuiltinLattices.STD_SECLEVEL_LOW);
		ThreadModularCDomOracle tmdo = new ThreadModularCDomOracle(sdg);
		ProbInfComputer probInf = new ProbInfComputer(sdg, tmdo);
		ORLSODChecker<String> checker = new PathBasedORLSODChecker<String>(sdg, BuiltinLattices.getBinaryLattice(), srcAnn, snkAnn, probInf);
		checker.check();
	...
	private static void doORLSOD5_precise() throws ClassHierarchyException, IOException, UnsoundGraphException, CancelException {
		SDG sdg = JoanaRunner.buildSDG("example/bin", "Lorlsod/ORLSOD5");
		CSDGPreprocessor.preprocessSDG(sdg);
		CFG redCFG = ReducedCFGBuilder.extractReducedCFG(sdg);
		Util.removeCallCallRetEdges(redCFG);
		DomExperiment.export(redCFG, DomExperiment.joanaGraphExporter(), "orlsod5.dot");
		PreciseMHPAnalysis mhp = PreciseMHPAnalysis.analyze(sdg);
		PruneInterferences.pruneInterferences(sdg, mhp);
		PrintWriter pw = new PrintWriter("orlsod5.pdg");
		SDGSerializer.toPDGFormat(sdg, pw);
		pw.close();
		Map<SDGNode, String> srcAnn = new HashMap<SDGNode, String>();
		srcAnn.put(sdg.getNode(7), BuiltinLattices.STD_SECLEVEL_HIGH);
		Map<SDGNode, String> snkAnn = new HashMap<SDGNode, String>();
		snkAnn.put(sdg.getNode(139), BuiltinLattices.STD_SECLEVEL_LOW);
		snkAnn.put(sdg.getNode(148), BuiltinLattices.STD_SECLEVEL_LOW);
		ThreadModularCDomOracle tmdo = new ThreadModularCDomOracle(sdg);
