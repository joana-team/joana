...
public class ViewContextMenu_CenterInterferingRegionsAction extends Action {
	public ViewContextMenu_CenterInterferingRegionsAction() {
		super();
		...
		ImageDescriptor desc = ir.getDescriptor(Activator.IMAGE_VIEW_CONTEXTMENU_CENTER_NODE);
