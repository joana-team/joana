...
public class ViewContextMenu_FollowNodeAction extends Action {
	public ViewContextMenu_FollowNodeAction() {
		super();
		setText("Follow Node");
		setToolTipText("Follows the selected node in code.");

		ImageRegistry ir = Activator.getDefault().getImageRegistry();
		ImageDescriptor desc = ir.getDescriptor(Activator.IMAGE_VIEW_CONTEXTMENU_FOLLOW_NODE);
