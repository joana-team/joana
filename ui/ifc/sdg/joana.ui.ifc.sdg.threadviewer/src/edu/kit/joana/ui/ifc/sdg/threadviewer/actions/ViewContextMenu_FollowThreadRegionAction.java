...
public class ViewContextMenu_FollowThreadRegionAction extends Action {
	public ViewContextMenu_FollowThreadRegionAction() {
		super();
		...
		ImageDescriptor desc = ir.getDescriptor(Activator.IMAGE_VIEW_CONTEXTMENU_FOLLOW_THREAD_REGION);
