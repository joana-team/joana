...
public class ViewToolbar_CenterParallelRegionAction extends Action {
	public ViewToolbar_CenterParallelRegionAction() {
		super();
		...
		ImageDescriptor desc = ir.getDescriptor(Activator.IMAGE_VIEW_TOOLBAR_CENTER_REGION);
