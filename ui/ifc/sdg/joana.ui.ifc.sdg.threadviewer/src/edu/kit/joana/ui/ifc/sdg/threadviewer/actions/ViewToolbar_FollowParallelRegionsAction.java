...
public class ViewToolbar_FollowParallelRegionsAction extends Action {
	public ViewToolbar_FollowParallelRegionsAction() {
		super();
		...
		ImageDescriptor desc = ir.getDescriptor(Activator.IMAGE_VIEW_TOOLBAR_FOLLOW_PARALLEL_REGIONS);
