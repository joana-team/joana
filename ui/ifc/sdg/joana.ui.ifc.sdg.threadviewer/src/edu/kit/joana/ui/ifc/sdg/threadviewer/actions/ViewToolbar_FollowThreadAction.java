...
public class ViewToolbar_FollowThreadAction extends Action {
	public ViewToolbar_FollowThreadAction() {
		super();
		...
		ImageDescriptor desc = ir.getDescriptor(Activator.IMAGE_VIEW_TOOLBAR_FOLLOW_THREAD);
