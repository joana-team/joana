 ...
 */
package edu.kit.joana.util.graph.io.dot;
...
/**
 * Convenience class which provides the possibility to export AbstractJoanaGraphs to the dot format
 * @author Martin Mohr
 */
public final class AbstractJoanaGraph2Dot {
	
	/** prevent instantiation of this utility class */
	private AbstractJoanaGraph2Dot() {}
	 ...
	 */
	public static final <V,E> void writeDotToOutputStream(AbstractJoanaGraph<V,E> joanaGraph, VertexNameProvider<V> vIdProvider, VertexNameProvider<V> vNameProvider, EdgeNameProvider<E> edgeNameProvider, OutputStream out) {
