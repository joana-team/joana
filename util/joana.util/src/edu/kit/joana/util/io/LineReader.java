...
public final class LineReader {
  ...
  private final Queue<Pair<String,String>> lines = new LinkedList<>();
  private final LineBuffer lineBuf = new LineBuffer() {
    @Override protected void handleLine(String line, String end) {
      lines.add(Pair.pair(line, end));
    }
  };
   ...
   * ({@code "\r\n"}).
   *
   * @return a {@code Pair} of two {@code String}s, the first containing the contents of the line
   *     (not including any line-termination characters),  and the second containing the 
   *     line line-termination characters.
   *     Returns {@code null} if the end of the stream has been reached.
   * @throws IOException if an I/O error occurs
   */
  public Pair<String, String> readLine() throws IOException {
