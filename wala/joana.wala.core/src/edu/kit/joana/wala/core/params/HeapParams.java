...
public class HeapParams {
	...
	private void merge(DependenceGraph ddg, TIntObjectMap<Set<PDGNode>> folded, List<PDGNode> toMerge) {
		...
		PDGNode fld = new PDGNode(sdg.getNextNodeId(), SDGBuilder.NO_PDG_ID, label, PDGNode.Kind.FOLDED, PDGNode.DEFAULT_TYPE, PDGNode.DEFAULT_NO_LOCAL, PDGNode.DEFAULT_NO_LOCAL);
