...
import edu.kit.joana.wala.dictionary.accesspath.AliasSDG.Alias;
...
public interface FlowCheckResultConsumer {
	...
	public static FlowCheckResultConsumer DEFAULT = new FlowCheckResultConsumer() {
	...
	public static FlowCheckResultConsumer STDOUT = new FlowCheckResultConsumer() {
