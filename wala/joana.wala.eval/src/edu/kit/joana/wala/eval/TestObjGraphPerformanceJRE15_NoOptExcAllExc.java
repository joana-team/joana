 ...
 */
public class TestObjGraphPerformanceJRE15_NoOptExcAllExc extends TestObjGraphPerformance {
	...
	protected void postCreateConfigHook(final SDGConfig config) {
		// TDOD: this is different from TestObjGraphPerformanceJRE14_NoOptExcAllExc,
